      ...
      <div className="mt-auto space-y-4 pt-6 border-t border-content-primary/5">
        <div className="px-2 py-3 rounded-2xl bg-bg-elevated/50 border border-content-primary/5 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-sm font-bold text-content-primary truncate">Tejas Patil</p>
            <p className="text-[10px] text-accent-gold font-bold truncate">Premium Member</p>
          </div>
        </div>

        <button 
          onClick={signOut}
          className="flex items-center gap-3 px-4 py-3 rounded-2xl text-danger hover:bg-danger/5 transition-all group w-full font-bold text-sm"
        >
